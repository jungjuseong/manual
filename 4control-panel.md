...
컨트롤 패널의 기본 모드는 홈 탭입니다. 여기에서는 객체를 편집하기 위한 다양한 기능들을 보여줍니다.
...
메뉴에서 삽입 탭을 선택하면 리본 메뉴는 삽입 모드로 바뀝니다.
...
텍스트 박스를 클릭하고 작업 영역에 드래그를 하면 텍스트 박스가 생성됩니다. 텍스트 박스를 더블 클릭하면 텍스트 작성이 가능합니다.
...
이미지 박스를 선택하시면 이미지 박스의 리본 메뉴가 생성됩니다. 
