...
3. 설치될 폴더를 지정한 후  <button name="button">다음(N)></button>을 클릭합니다. <br>
 <br><img src='./figure/2-3.jpg' width=500pt>

4. 다음 화면에서 <button name="button">설치(I)></button>을 클릭합니다. <br>
...
<img src='./figure/1-0.jpg' width="300">
...
3. 회원가입 시 입력한 메일 주소에서 이메일 인증 메일을 확인합니다. <br>

   <img src='./figure/0-2.jpg' width="500">

4. 메일 확인 후, 로그인을 하면 회원가입이 완료된 것을 볼 수 있습니다. <br>
